...
const Contact = (props) => {
  ...
  return (
    <>
      <h1 className='aboutme' id='contact' style={{ textAlign: 'center', marginBottom: '80px' }} data-aos={"zoom-in-down"}>{props.btn}</h1>
      ...
      <div className='contact' >
        <div className='login' data-aos={"zoom-in-down"}>
          <img src={tech} alt='techimg' />
        </div>
        <div className='login-contact' data-aos={"zoom-in-down"}>
