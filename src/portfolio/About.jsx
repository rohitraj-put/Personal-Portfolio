        ...
        <>
            <div className='about' id='about' >
                ...
                <div className='mainabout'>
                    ...
                    <div className='imgabout' data-aos={"flip-up"}>
            ...
            <h1 className='aboutme userText' id='project' style={{ textAlign: 'center', marginBottom: '80px' }} data-aos={"zoom-in-down"}>{props.fileName}</h1>
